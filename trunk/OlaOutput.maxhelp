{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 447.0, 235.0, 511.0, 458.0 ],
		"bglocked" : 0,
		"defrect" : [ 447.0, 235.0, 511.0, 458.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 200.0, 250.0, 225.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 20.0, 370.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 20.0, 410.0, 240.0, 32.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 380.0, 128.0, 55.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.0, 310.0, 257.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "bang" ],
					"patching_rect" : [ 200.0, 270.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"text" : "OLA Output sends recieves a list of integers in the range 0-255 and sends them to OLA for transmission via IP or hardware.",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 140.0, 310.0, 81.0, 20.0 ],
					"text" : "OLAOutput 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 370.0, 380.0, 130.0, 60.0 ],
